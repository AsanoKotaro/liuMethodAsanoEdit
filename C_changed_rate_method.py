...
def data_shuffer(share_pattern,share_percent,data_r1,data_r2):# データ共有率    
    #print(share_percent)
...
if __name__ == "__main__":
    ...
    episode_num = 1000 #　エピソードの数(必ずadjust_episodesより多い)
    inital_episodes = 25#初期エピソード(必ずchange_widthの２倍より多い)
    adjust_episodes = 300#調整エピソード+初期エピソード       
    ...
    path = 'learning_data/log'+str(str_time)+'.csv'#["Episode",'step','a1','a2','done','goal_num']
 
    with open(path,'w') as f:
        csv_write = csv.writer(f)
        csv_head = ['trial','Episode','total_reward','total_steps','x','two_treasures','one more treasures','traps']
    ...
    for trial in range(trials):  
        ...
        for episode in range(episode_num):
            ...
            for step in range(max_steps_num):
                ...
                data.append(episode_done)#done
                data.append(r)#reward
                data.append(str(goals_num))#the num of goal
            ...
            result_log.append(str(GOAL_EP + one_goal_ep))
            ...
            """
            pattern_log.append(str(trial+1))#trial
            pattern_log.append(str(episode+1))#episode
            pattern_log.append(str(ep_r))#episode
            pattern_log.append(str(share_pattern[0]))#share_pattern
            pattern_log.append(str(share_pattern[1]))#share_pattern
            
            with open(path,'a') as f:
                csv_write = csv.writer(f)
                csv_write.writerow(pattern_log)
            """
            ...
            if is_share_data:#データを共有する
                ...
                learning_data_r1,learning_data_r2 = data_shuffer(share_pattern,share_percent,learning_episodes_buffer_data_r1,learning_episodes_buffer_data_r2)
            ...
            if is_adjust == True and  (inital_episodes <= (episode+1) < adjust_episodes) and (counter % change_width == 0) and counter > 0:
